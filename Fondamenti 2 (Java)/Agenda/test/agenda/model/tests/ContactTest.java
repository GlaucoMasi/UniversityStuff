...
public class ContactTest {
	...
	@Test
	void testKO() {
		assertThrows(IllegalArgumentException.class, () -> new Contact("", "Molesini"));
		assertThrows(IllegalArgumentException.class, () -> new Contact("Ambra", ""));
		assertThrows(NullPointerException.class, () -> new Contact(null, "Molesini"));
		assertThrows(NullPointerException.class, () -> new Contact("Ambra", null));
