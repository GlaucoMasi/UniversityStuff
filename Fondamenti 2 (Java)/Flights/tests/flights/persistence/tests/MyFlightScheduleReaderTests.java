...
public class MyFlightScheduleReaderTests {
	...
	public void testRead() throws IOException, BadFileFormatException {
		...
		Airport arr = new Airport("Arr", "Arrival", new City("Can", "Canicatti", 4));
		...
		String toRead = "AZ1344,Dep,14:30,Arr,17:15,0,1-3-5-7,111\nAZ1345,Dep,07:00,Arr,10:45,0,-2-4-6-,999\n";
		...
		assertEquals(LocalTime.of(17, 15), fs.getArrivalLocalTime());
		...
		assertEquals(arr, fs.getArrivalAirport());
		assertEquals(LocalTime.of(10, 45), fs.getArrivalLocalTime());
		assertEquals(0, fs.getDayOffset());
