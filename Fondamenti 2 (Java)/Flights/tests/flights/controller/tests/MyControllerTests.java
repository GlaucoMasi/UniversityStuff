...
import flights.persistence.tests.DataManagerMock;


public class MyControllerTests {

	static LocalDate getLocalDateWith(DayOfWeek day) {
	...
	public void testGetSortedAirports() {
		...
		Airport[] airports = controller.getSortedAirports().toArray(new Airport[0]);
	...
	public void testSearchFlights() {
		...
		LocalDate date = getLocalDateWith(DayOfWeek.MONDAY);
	...
	public void testSearchFlights_NotFound1() {
		...
		LocalDate date = getLocalDateWith(DayOfWeek.SUNDAY);
		List<FlightSchedule> schedules = controller.searchFlights(dep, arr,date);
