...
public class Aircraft {
	...
	public Aircraft(String code, String description, int seats) {
		if(code==null || description == null) throw new NullPointerException("arg nulli in Aircraft");
		if(code.isEmpty() || description.isEmpty() || seats <= 0)throw new IllegalArgumentException("arg invalidi in Aircraft");
		this.code = code;
