...
public class Airport {
	...
	public Airport(String code, String name, City city) {
		if(code==null || name == null || city == null) throw new NullPointerException("arg nulli in Airport");
		if(code.isEmpty() || name.isEmpty())throw new IllegalArgumentException("arg invalidi in Aircraft");
		this.code = code;
		this.name = name;
		this.city = city;
	}
