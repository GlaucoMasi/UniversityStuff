...
public class City {
	...
	public City(String code, String name, int timeZone) {
		if(code==null || name == null ) throw new NullPointerException("arg nulli in City");
		if(code.isEmpty() || name.isEmpty() || timeZone<-12 || timeZone>12)throw new IllegalArgumentException("arg invalidi in city");
		this.code = code;
		this.name = name;
