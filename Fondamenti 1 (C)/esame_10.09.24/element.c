...
int compare(element a, element b) {
	if (strcmp(a.posizione, b.posizione) != 0) return strcmp(a.posizione, b.posizione);
	else if (a.stipendio != b.stipendio) return (a.stipendio > b.stipendio ? -1 : 1);
	else return (a.esperienza <= b.esperienza ? -1 : 1);
}
...
void printelement(element a) {
	printf("%s %s %c %d %d\n", a.code, a.posizione, a.settore, a.esperienza, a.stipendio);
}
